...
-- Last modification date: 2022-04-27 10:27:38.547
...
ALTER TABLE internship_opportunity ADD CONSTRAINT internship_oportunity_work_options
...
ALTER TABLE picture ADD CONSTRAINT picture_student
    FOREIGN KEY (student_id)
    REFERENCES student (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE required_technology ADD CONSTRAINT required_technology_internship_oportunity
    FOREIGN KEY (internship_opportunity_id)
    REFERENCES internship_opportunity (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
ALTER TABLE required_technology ADD CONSTRAINT required_technology_technology
